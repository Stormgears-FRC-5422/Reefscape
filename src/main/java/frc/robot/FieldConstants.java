...
public class FieldConstants {
    ...
    public static Pose2d getPoseTag(int id) {
        return switch (id) {
            ...
            case 6 ->
                new Pose2d(Constants.Vision.tag6X, Constants.Vision.tag6Y, new Rotation2d(Constants.Vision.tag6Rotation));
            case 7 ->
                new Pose2d(Constants.Vision.tag7X, Constants.Vision.tag7Y, new Rotation2d(Constants.Vision.tag7Rotation));
            case 8 ->
                new Pose2d(Constants.Vision.tag8X, Constants.Vision.tag8Y, new Rotation2d(Constants.Vision.tag8Rotation));
            case 9 ->
                new Pose2d(Constants.Vision.tag9X, Constants.Vision.tag9Y, new Rotation2d(Constants.Vision.tag9Rotation));
            case 18 ->
    ...
    public static Pose2d getReefTargetPose(Side side, int id) {
        if ((id <= 11 && id >=6) || (id >= 17 && id <=22)) {
            if (side == Side.LEFT) {
                return getPoseTag(id).transformBy(new Transform2d(new Translation2d(0, 0), new Rotation2d(0)));
