...
public class AKTunerConstantsTest {
    ...
    private static final Slot0Configs FLsteerGains = new Slot0Configs()
        ...
        .withKS(4.8).withKV(0.0).withKA(0)
    ...
    private static final Slot0Configs BRsteerGains = new Slot0Configs()
        .withKP(87).withKI(0.0).withKD(8.75)
        .withKS(5.1).withKV(0.0).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    //    kv 2.66 ks 0.1
    ...
    public static final CANBus kCANBus = new CANBus(Constants.Drive.driveCAN, "./logs/example.hoot");
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.223876953125);
     ...
     */
    public static CTRDriveInternal createDrivetrain() {
        return new CTRDriveInternal(
